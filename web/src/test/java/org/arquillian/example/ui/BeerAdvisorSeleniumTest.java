 ...
 * <li>But most importantly if you keep writing tests in this style and your UI will be changed you will immediately end
 * up with "maintenance hell"</li>
 * <li>Another problem is that WebDriver is managed by you and the URL is hardcoded.</li>
 * <li>This obviously can be externalized to the system properties, but in some cases you might not know URL of your
 * deployed application beforehand (hello cloud!).</li>
